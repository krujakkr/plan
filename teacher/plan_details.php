...
// ดึงข้อมูลแผน (ต้องเป็นของครูคนนี้เท่านั้น)
...
<div class="max-w-5xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <a href="my_plans.php" class="text-blue-600 hover:text-blue-700 inline-flex items-center mb-4">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <div class="space-y-2">
            ...
            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <?php endfor; ?>
                    <span class="font-bold text-blue-600 ml-2"><?php echo $score; ?></span>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="mt-6 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-lg">
            ...
            <p class="text-gray-700 whitespace-pre-line"><?php echo nl2br(htmlspecialchars($plan['comments'])); ?></p>
        </div>
        <?php endif; ?>
    ...
    <div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg">
        <div class="flex items-center">
            ...
            <p>แผนนี้อยู่ระหว่างรอการประเมิน</p>
        </div>
    </div>
    <?php endif; ?>
</div>
